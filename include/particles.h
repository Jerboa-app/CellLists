...
uint64_t step(float * X, float * Xp, uint64_t * list, uint64_t * cells, float * offsets, float * thetas, std::default_random_engine generator, int N, int Nc, float delta, float L, float Dr, float r, float k, float v0, float dt);
